...
/* postconditin:      queue is initialized to being empty */
...
/* precondition     pq points to previously intitialized queue */
/* postcondition    returns True if queue is empty, else False */
bool QueueIsEmpty(const Queue * pq);

/* operation:      determine if number of items in queue  */
/* precondition     pq points to previously initialized queue */
...
/* precondition:     pq points to previously initialized queue     */
/*                rear of queue is not empty, item is placed  */
/*                at rear of queue and function returns      */
/* postcondition:     if queue is not empty, item is placed at    */
/*                 rear of queue and function returns True;   */
/*                 otherwise, queue is unchanged and       */
...
/*               is copied to *pitem and deleted from queue, and */
/*               function returns True; if the operation empties the */
/*               queue, the queue is set to empty. If the queue is */
/*               empty to begin with, queue is unchanged and the */
/*               function returns False                         */
