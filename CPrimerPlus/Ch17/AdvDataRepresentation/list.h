...
typedef Node * List; 
/* function prototypes */
/* operation:           intitialize a list                    */
/* preconditions:         plist points to a list               */
/* postconditions:        the list is initialized to empty        */
void InitializeList(List * plist); 

/* operation:          determine if list is empty             */
/*                   plist points to a list                 */
...
/*                     plist points to an intialized list        */
/* postcondtions          if possible, function adds item to end  */
...
/* operation:           free allocated memory. if any plist points */
/*                    to an initialized list                   */
/* postcontditions:       any memory allocated for the list is freed */
