// stirngs.c -- stringing the user along 
#include<stdio.h> 

#define MSG "You must have many talents. Tell me some"
                                // a symbolic string 
#define LIM 5 
#define LINELEN 81              // maximum string length
...
int main(void)
{
    ...
    const char *mytal[LIM] = {      // array of 5 pointers
        "Adding numbes swiftly", 
        "Multiplying accurately", "Stashing data", 
        "Following instructions to the letter",
        "Understanding the C language"
    };
    printf("Hi! I'm HAL the Computer." 
         " I have many talents, atlease 9000.\n"); 
